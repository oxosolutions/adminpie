...
try{
    ...
    public function create_db_through_migration($org_id){
		...
		Artisan::call('make:migration:schema',[
                                ...
                                '--schema'=>'name:text, employee_id:integer, type:string:nullable, reason_of_leave:string:nullable, leave_category_id:integer, from:date, to:date, from_leave_count:integer:nullable, to_leave_count:integer:nullable, description:text:nullable, total_days:float:nullable, apply_by:string, approved_by:string:nullable, status:integer']);

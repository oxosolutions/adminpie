...
class RegisterController extends Controller
{
    ...
    */
    ...
    /**
     * [sendNewUserEmaiToAdmin description]
     * @param  [type] $request [description]
     * @return [type]          [description]
     */
    protected function sendNewUserEmaiToAdmin($request)
    {
        $templateAndLayout = $this->getEmailTemplateAndLayout('admin');
        if($templateAndLayout != false){
    ...
    /**
     * [getEmailTemplateAndLayout description]
     * @return [type] [description]
     */
    protected function getEmailTemplateAndLayout($templateType = 'user')
    {

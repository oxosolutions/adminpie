<?php
	...
	Route::get('/organization/view/{id}',		['as'=>'view.groupOrganizations','uses'=>'GroupOrganizationController@viewOrg']);
	...
	Route::get('/organization/share/{id}',		['as'=>'share.groupOrganization','uses'=>'GroupOrganizationController@share']);
	...
	Route::get('organization/change/status/{id}' , ['as' => 'change.group.org.status','uses' => 'GroupOrganizationController@changeStatus']);

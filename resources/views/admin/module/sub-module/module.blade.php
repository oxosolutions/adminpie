    ...
    <div class="col s12 m2 l12 aione-field-wrapper">
        <div class="row">
            <div class="col l6 pr-7">
                ...
                <input type="text" name="submodule[{{$count}}][submodule_name]" value="" placeholder="Enter sub-module name" />
            </div>
            <div class="col l6 pl-7">
                <label>Sub Module Route</label>
                {!!Form::select('submodule['.$count.'][sub_module_route]',App\Model\Admin\GlobalModule::getRouteListArray(),null, ['class'=>'form-control sel browser-default','placeholder'=>'url ']) !!}
                <input type="hidden" name="submoduleNumber" value="{{$count}}" />
            </div>
        </div>

...
// });
    ...
    <div class="card" style="margin-top: 0px;padding: 10px">
        ...
        <div class="col s12 m2 l12 aione-field-wrapper">
            <label>Name</label>
            <input name="module_id" type="text" value="{{$module->id}}" >
                    ...
                    <div class="col s12 m2 l12 aione-field-wrapper">
                        <div class="row">
                            <div class="col l6">
                                ...
                                <input name="submodule[{{$loop->index}}][submodule_id]" type="text" value="{{$submodule->id}}">
                                <input type="text" name="submodule[{{$loop->index}}][name]" value="{{$submodule->name}}" placeholder="Enter sub-module name" />          
                            </div>
                            <div class="col l6">
                                ...
                                <div class="col s12 m2 l12 aione-field-wrapper" style="border: 1px solid #e8e8e8;padding: 14px; margin-top: 1%;">
                                    ...
                                    <div class="row valign-wrapper">
                                        <div class="col l5 pr-7">
                                            ...
                                            <input type="text" name="route[{{$loop->index}}][route_id]" value="{{$route->id}}">
                                            <input type="text" name="route[{{$loop->index}}][route_name]" value="{{$route->route_name}}" placeholder="Enter route name" />
                                        </div>
                                        <div class="col l6 pl-7 pr-7">
                                            <label>Route</label>
                                            {!!Form::select('route['.$loop->index.'][route]',App\Model\Admin\GlobalModule::getRouteListArray(),$route->route, ['class'=>'form-control sel browser-default','placeholder'=>'url ']) !!}
                                        </div>

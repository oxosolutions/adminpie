    ...
    <style type="text/css">
        ...
        .postfix{
            display: {{($value->field_type == 'auto-generator')?'block':'none'}};
        }
    </style>
    <div class="main-row">
           ...
           <div>
            ...
            <div class="fields_list active-field">
                ...
                <div class="row field_row postfix">
                    ...
                    <div class="col l8 form-group" style="padding:10px">
                         <input type="text" name="prefix[{{$rowCount}}]" class="form-control field-label-input" value="{{@$namespace::getMetaByKey(@$value->fieldMeta,'prefix')}}">
                    </div>
                </div>
                <div class="row field_row postfix">
                    <div class="col l4 left-align grey lighten-5" style="padding:20px">
                    ...
                    <div class="col l8 form-group" style="padding:10px">
                         <input type="text" name="postfix[{{$rowCount}}]" class="form-control field-label-input" value="{{@$namespace::getMetaByKey(@$value->fieldMeta,'postfix')}}">
                    </div>
                </div>
                <div class="row field_row postfix">
                    <div class="col l4 left-align grey lighten-5" style="padding:20px">
                    ...
                    <div class="col l8 form-group" style="padding:10px">
                         <input  type="text" name="string_length[{{$rowCount}}]" class="form-control field-label-input" value="{{@$namespace::getMetaByKey(@$value->fieldMeta,'string_length')}}">
                    </div>
                </div>

<tr class="form-row option-trigger">
  ...
  <td>
    ...
    <span style="float:right;border:1px solid #e8e8e8;line-height: 34px;width: 34px;margin: 0 auto;border-radius: 50%" class="row-count">1</span>
  ...
  <td style="width: 300px">
    <div class="row">
      ...
      <div class="" style="font-size: 12px;height: 0px">
        <span class="options">
          <a href="javascript:void(0)" class="edit-fields" style="border:0px !important">Edit </a>|
...
<tr class="fields-list" style="display: none;">

    ...
    <div class="col l4">
      <div class="row">
        ...
        <div class="" style="font-size: 12px;height: 0px">
          <span class="options">
            <input type="hidden" name="field_id[{{$rowCount}}]" value="name">
        ...
        <div class="fields_list active-field">
            <div class="row field_row">
                ...
                <div class="col l8 form-group"  style="padding: 10px">
                     <input type="text" required="required" name="field_title[{{$rowCount}}]" class="form-control field-label-input">
                </div>
            </div>
            <div class="row field_row">
                ...
                <div class="col l8 form-group" style="padding:10px">
                    ...
                    <input type="text" required="required" id="textarea2" class="materialize-textarea" name="field_description[{{$rowCount}}]">
                </div>  
            </div>
            <div class="row field_row">
                ...
                <div class="col l8 input-field" style="padding:10px">
                    <select required="required" name="field_type[{{$rowCount}}]" class="field_type">
            ...
            <div class="row field_row">
                ...
                <div class="col l8 form-group" style="padding:10px">
                     <input required="required" type="text" name="field_order[{{$rowCount}}]" class="form-control field-label-input">
                </div>
            </div>
            <div class="row field_row prefix">
                ...
                <div class="col l8 form-group" style="padding:10px">
                     <input type="text" name="prefix[{{$rowCount}}]" class="form-control field-label-input">
                </div>
            </div>
            <div class="row field_row postfix">
                ...
                <div class="col l8 form-group" style="padding:10px">
                     <input type="text" name="postfix[{{$rowCount}}]" class="form-control field-label-input">
                </div>
            </div>
            <div class="row field_row postfix">
                <div class="col l4 left-align grey lighten-5" style="padding:20px">
                ...
                <div class="col l8 form-group" style="padding:10px">
                     <input type="text" name="string_length[{{$rowCount}}]" class="form-control field-label-input">
                </div>
            </div>
            <div class="row field_row">
                <div class="col l4 left-align grey lighten-5 " style="padding:20px">
                ...
                <div class="col l8 form-group"  style="padding: 10px">
                    <input type="text" required="required" name="field_slug[{{$rowCount}}]" class="form-control field-label-input">
                </div>
            </div>
            <div class="row field_row">
                <div class="col l4 left-align grey lighten-5" style="padding:44px 20px">
            ...
            <div class="row field_row">
                ...
                <div class="col l6 form-group messages" style="padding:5px">
                    <input type="text" class="form-control" name="field_error_message[{{$rowCount}}][]">
                </div>  
            ...
            <div class="row field_row">
                ...
                <div class="col l6 form-group validations" style="padding:10px">
                     <input type="text" name="field_validation[{{$rowCount}}][]" class="form-control field-label-input">
                </div>
                <a href="javascript:;" class="add_validation" data-count="{{$rowCount}}">Add</a>
            </div>
            <div class="row field_row main-option-row">
                ...
                <div class="col l8 form-group" style="padding:5px">
                    <div class="row">
                        ...
                        <div class="col l2">
                            <a href="javascript:;" class="add_options" data-count="{{$rowCount}}">Add</a>
                        </div>
                    </div>
            ...
            <div class="row field_row main-option-row">
                ...
                <div class="col l8 form-group" style="padding:10px">
                    <input type="text" name="choice_model[{{$rowCount}}]" class="form-control" value="">
                </div>  
            </div>
            ...
            <div class="row field_row">
                ...
                <div class="col l8 form-group" style="padding:10px">
                    <input type="text" name="field_placeholder[{{$rowCount}}]" class="form-control">
                </div>  
            </div>
            <div class="row field_row">
                <div class="col l4 left-align grey lighten-5" style="padding:20px">
                ...
                <div class="col l8 form-group" style="padding:10px">
                    <input type="text" name="field_tooltip[{{$rowCount}}]" class="form-control">
                </div>  
            </div>
            <div class="row field_row">
                <div class="col l4 left-align grey lighten-5" style="padding:20px">
                ...
                <div class="col l8 form-group" style="padding:10px">
                    <input type="text" name="field_value[{{$rowCount}}]" class="form-control">
                </div>  
            </div>
            <div class="row field_row">
                <div class="col l4 left-align grey lighten-5" style="padding:20px">
                ...
                <div class="col l8 form-group" style="padding:10px">
                    <input type="text" name="field_class[{{$rowCount}}]" value="" class="form-control">
                </div>  
            </div>
        </div>
      </div>

			...
			<div class="col l9 pr-7">
				<div class="card">
					...
					<div class="row year-view">
						...
						{{-- <div class="line"><div class='mo'>April</div><div class='square'>1</div></div> --}}
							...
							<svg width="720" height="260" class="js-calendar-graph-svg">
							  <g transform="translate(16, 20)" style="font-size: 13px">
							      <g transform="translate(0, 0)">
							      	<g>
							      	  <rect class="day" width="18" height="18" x="20" y="0" fill="green" data="100000"></rect>
							      	  <text width="18" height="18" x="21" y="13" font-size="11" fill="green">P</text>
							      	</g>
							          <rect class="day" width="18" height="18" x="40" y="0" fill="#ebedf0" data-count="0" >22</rect>
							          <rect class="day" width="18" height="18" x="60" y="0" fill="#ebedf0" data-count="0" >22</rect>
							          <rect class="day" width="18" height="18" x="80" y="0" fill="#ebedf0" data-count="0" >22</rect>

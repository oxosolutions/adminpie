...
<div class="box-body no-padding">
  <input type="hidden" name="surrvey_id" value="">
      ...
      <div class="fields_list" style="display: none;">
        <div class="row field_row">
            ...
            <div class="col-md-8 form-group">
                 <input type="text" name="ques[]" value=" class="form-control field-label-input" />
            </div>
        </div>    
        ...
        <div class="row field_row">
            ...
            <div class="col-md-8 form-group">
                 <input type="text" name="fieldname[]" value="" class="form-control field-name" />
            </div>
        </div>
        ...
        <div class="row field_row">
            ...
            <div class="col-md-8 form-group">
               <select id="" class="select form-control type"  name="type[]">
        ...
        <div class="row field_row">
            ...
            <div class="col-md-8 form-group">
                 <input type="text" name="question_order[]" value="" class="form-control field-label-input" />
            </div>
        </div>
        <div class="row field_row">
            <div class="col-md-3">
            ...
            <div class="col-md-8 form-group">
                 <input type="text" name="media[]" value="" class="form-control field-label-input" />
            </div>
        </div>
        <div class="row field_row">
            <div class="col-md-3">
            ...
            <div class="col-md-8 form-group">
                 <input type="text" name="pattern[]" value="" class="form-control field-label-input" />
            </div>
        </div>
        <div class="row field_row">
            <div class="col-md-3">
            ...
            <div class="col-md-8 form-group">
                 <input type="text" name="extra_options[]" value="" class="form-control field-label-input" />
            </div>
        </div>
        <div class="row field_row">
            <div class="col-md-3">
            ...
            <div class="col-md-8 form-group">
                 <input type="text" name="validation[]" value="" class="form-control field-label-input" />
            </div>
        </div>
        <div class="row field_row">
            <div class="col-md-3" >

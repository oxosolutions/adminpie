		...
		<div class="card-panel shadow white z-depth-1 hoverable {{$id}}_project project" data-site="{{$projVal->name}}" >
			<div class="row valign-wrapper no-margin-bottom  ">
				...
				<div class="col l11 s10 ">
					<a href="{{route('details.project', ['id' => $projVal->id])}}" data-toggle="popover" title="Popover title" data-content="TEST">
					<h5 class="project-title black-text flow-text truncate project-name" id="name">{{$projVal->name}}</h5>
					</a>
					<p class="project-detail truncate">
					{{$projVal->description}}
					</p>
				</div>
				<div class="none sortable-data-div">

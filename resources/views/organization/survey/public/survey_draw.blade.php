                    ...
                    <div class="aione-float-left pr-15  " style="width: 360px">
                        <div class="sections-wrap">
                            ...
                            @foreach($data['sections'] as $key => $section)
                                ...
                                @endphp
                                <div class="item mb-10 {{ ($sectionIndex == $key)?'active':'' }} {{$completedClass}} {{ $partiallClass }}" onclick="window.location.href='{{ route('embed.survey',['token'=>request()->token]).'?section='.$key }}'" style="cursor: pointer;">
                ...
                <div class="ar view-by-question">
                    <div class="ac l25" >
                        @foreach($data['sections'] as $key => $section)
                            ...
                            @endphp
                            <div class="item mb-10 {{ ($sectionIndex == $key)?'active':'' }} {{ $completedClass }}" onclick="" style="cursor: pointer;">

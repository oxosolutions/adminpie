    ...
    <div class="aione-float-left pr-15	" style="width: 360px">
        <div>
            <div class="mb-10">
                <div class="pv-15 ph-10 aione-border  bg-white " style="position:relative;">
                    <div class="font-size-20 light-blue darken-2 font-weight-600 truncate " title="Basic detail section for personal information">
                        Basic detail section for personal information
                    </div>
            ...
            <div class="pv-15 ph-10 aione-border mb-10 bg-white" style="position:relative;">
                <div class="font-size-20 light-blue darken-2 font-weight-600">
                    Section Name
                </div>
                <div class="font-size-13 line-height-20">
                    24 Question
            ...
            <div class="pv-15 ph-10 aione-border mb-10 bg-light-blue bg-darken-2" style="position:relative;">
                <div class="font-size-20 white font-weight-600">
                    Section Name
                </div>
                <div class="font-size-13 line-height-20 white">
                    24 Question
                </div>
                <div class="indicater-wrapper" >
                    <div class="bg-light-blue bg-lighten-4 indicater">
                                            ...
                                            <div id="field_4" data-conditions="0" data-field-type="text" class="field-wrapper ac field-wrapper-rate-us field-wrapper-type-text ">
                                                <div id="field_label_rate-us" class="field-label">
                                                    <label for="input_rate-us">
                                                        <h4 class="field-title" id="Rate us (0 stands for low satisfaction and 5 stands for high satisfaction)">
                                                            Rate us (0 stands for low satisfaction and 5 stands for high satisfaction)
                                                        </h4>
                                                    </label>
                                                </div>
                                                <!-- field label-->

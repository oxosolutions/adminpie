...
@section('content')
	...
	{!! Form::open(['method' => 'POST','class' => '','route' => 'user.store']) !!}
		<div class="panel panel-flat">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					{!!Form::select('userType',App\Model\Organization\UsersType::userTypes(), null, ['class'=>'select2','style'=>'display:block;','multiple'=>'multiple'])!!}
				</div>

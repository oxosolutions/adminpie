			...
			<div class="list">
					...
					<div class="card-panel white z-depth-1 hoverable project " >
						<div class="row valign-wrapper no-margin-bottom  ">
							<div class="col s2 center-align project-image-wrapper">
								<a href="{{route('add_project_info.project', ['id' => 1])}}" data-toggle="popover" title="Popover title" data-content="TEST">
								{{-- <img src="{{ asset('assets/images/sgs_sandhu.jpg') }}" alt="" class="project-image circle responsive-img">  --}}
								<div class="image-alternate" style="padding: 1px;background: #0288d1;color: white;height: 78px;border-radius: 100%;width: 80px;line-height: 76px;font-size: 38px;">TT</div>
								</a>
							</div>
							
							<div class="col s10 ">
								<a href="{{route('add_project_info.project', ['id' => 1])}}" data-toggle="popover" title="Popover title" data-content="TEST">
								<h3 class="project-title black-text flow-text truncate project-name">Team name</h3>
								</a>
		...
		<div class="col s12 m12 l3">
			...
			<div class="card hoverable light-blue darken-2 no-margin-top">	
				<div class="card-content center-align p-10">
			      <span class="card-title activator white-text text-darken-2 no-margin-bottom"><i class="material-icons">add_circle_outline</i> Add New Team</span>
			    </div>
			</div>
			</a>

...
<nav id="aione_account_tabs" class="aione-account-tabs aione-nav aione-nav-horizontal"  >
  <ul id="sortable_tabs" class="aione-tabs">
       <li class="aione-tab aione-tooltip dataset-view-tab {{(Request::route()->action['as'] == 'view.dataset')?'nav-item-current':''}}" title="View">
       ...
       <li class="aione-tab aione-tooltip dataset-edit-tab  {{(Request::route()->action['as'] == 'edit.dataset')?'nav-item-current':''}}" title="Edit">
       ...
       <li class="aione-tab aione-tooltip dataset-structure-tab  {{(Request::route()->action['as'] == 'structure.dataset')?'nav-item-current':''}}" title="Edit">
        ...
        <li class="aione-tab aione-tooltip dataset-filter-tab  {{(Request::route()->action['as'] == 'filter.dataset')?'nav-item-current':''}}" title="Data Filter">
      ...
      <li class="aione-tab aione-tooltip dataset-api-tab  {{(Request::route()->action['as'] == 'api.dataset')?'nav-item-current':''}}" title="API" style="display: none;">
        ...
        <li class="aione-tab aione-tooltip dataset-validate-tab  {{(Request::route()->action['as'] == 'validate.dataset')?'nav-item-current':''}}" title="Validate">
      ...
      <li class="aione-tab aione-tooltip dataset-operation-tab  {{(Request::route()->action['as'] == 'options.dataset')?'nav-item-current':''}}" title="Operations">
      ...
      @if($dataset_user_id == $auth_user_id)
          <li class="aione-tab aione-tooltip dataset-collaborate-tab  {{(Request::route()->action['as'] == 'collaborate.dataset')?'nav-item-current':''}}" title="Collaborate">

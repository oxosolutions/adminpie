                    ...
                    <div class="col-xs-2">
                      <div class="form-group">              
                        <div class="input-group date">
                          ...
                          <input name="from" type="text" value="{{@$req->from}}" class="form-control pull-right" id="datepickerFrom"  placeholder="From Date">
                        </div>
                      </div>                             
                    </div>
                    <div class="col-xs-2">
                      <div class="form-group">
                       <div class="input-group date">
                          ...
                          <input name="to" value="{{@$req->to}}" type="text" class="form-control pull-right" id="datepickerTo" placeholder="To Date">
                        </div>
                      </div>
                    </div>
                  <div class="col-xs-2">

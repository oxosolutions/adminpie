    ...
    <div class="card">
       <div class="input-field col s4">
            <select class="filter_priority">
              ...
              <option {{(@$prioritySelect == 'low')?'selected': ''}} value="low">Low</option>
              <option {{(@$prioritySelect == 'medium')?'selected': ''}} value="medium">Medium</option>
              <option {{(@$prioritySelect == 'high')?'selected': ''}} value="high">High</option>
            </select>
                                                                ...
                                                                <div class="modal-content" style="padding: 30px;padding-bottom: 100px">
                                                                   ...
                                                                   <div class="col s12 m2 l12 aione-field-wrapper">
                                                                    ...
                                                                    <div class="col s12 m2 l12 aione-field-wrapper">
                                                                        ...
                                                                        @if($usersName != null)
                                                                            <div class="col s12 m2 l12 aione-field-wrapper">
                                                                                {!! Form::text('assign_to',@$tasks->users->name,["class"=>"no-margin-bottom aione-field" , 'placeholder'=>'Select Employee to assign this task','readonly'=>'readonly'])!!}
                                                                                <input type="hidden" value="{{Auth::guard('org')->user()->id}}" name="assign_to" />
                                                                            </div>
                                                                        @else
                                                                            <div class="col s12 m2 l12 aione-field-wrapper">
                                                                                {!! Form::select('assign_to',App\Model\Organization\Employee::employees(),@$tasks->users->name,["class"=>"no-margin-bottom aione-field" , 'placeholder'=>'Select Employee to assign this task'])!!}
                                                                            </div>
                                                                        @endif
                                                                    <div class="col s12 m2 l12 aione-field-wrapper">
                                                                   ...
                                                                   <div class="col s12 m2 l12 aione-field-wrapper">
                                                                    ...
                                                                    {{-- <div class="col s12 m2 l12 aione-field-wrapper" style="margin-bottom: 10px">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col l9">
                                                                                {!!Form::file('browse_attachment',,['class'=>'no-margin-bottom aione-field','placeholder'=>'Select File'])!!}
                                                                            </div>
                                                                        </div>

...
@if(isset($options['type']))
	@if($options['type'] == 'inset')
		<div class="col s12 m2 l12 aione-field-wrapper">
			 {!!Form::password(str_replace(' ','_',strtolower($collection->field_title)).$fieldType,['class'=>'no-margin-bottom aione-field','placeholder'=>FormGenerator::GetMetaValue($collection->fieldMeta,'field_placeholder')])!!}
		</div>
		<div class="error-red">	
			@if(@$errors->has())

...
@endphp
@include('layouts.themes.theme-admin.includes._head')
	...
	<div id="aione_wrapper" class="aione-wrapper aione-layout-{{@$design_settings['layout']}} aione-theme-arcane">
		<div class="aione-row">
			...
			@if(@$design_settings['show_slider'] == 1)
				@include('layouts.themes.theme-admin.includes._slider')
			@endif
			@if(@$design_settings['show_page_title'] == 1)
				@include('layouts.themes.theme-admin.includes._pagetitle')
			@endif
			...
			@if(@$design_settings['show_footer_widgets'] == 1)
				@include('layouts.themes.theme-admin.includes._footer')
			@endif
			@if(@$design_settings['show_copyright'] == 1)
				@include('layouts.themes.theme-admin.includes._copyright')
			@endif
		</div><!-- .aione-row -->
	</div><!-- #aione_wrapper -->

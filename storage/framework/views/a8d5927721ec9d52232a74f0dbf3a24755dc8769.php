	...
	<div class="ar pv-20 pt-20">
		...
		<div class="ac l60 pt-25 aione-shadow pb-25 bg-grey bg-lighten-5">
			<div class="Wrapper aione-align-center">
				<div class="img-wrap ">
				    <img class="" src="<?php echo e(asset('assets/images/check-box.png')); ?>"/>	
				</div>
				...
				<div class="button-wrap pt-10">
					<button class="bg-light-blue bg-darken-2 aione-shadow"><i class="fa fa-check icon1 font-size-23 mb-16"></i>Start Again</button>
				</div>
				<div class=" clearfix button-wrap1">	
					<button class="bg-light-blue bg-darken-2 aione-shadow "><i class="fa fa-close icon2 font-size-23 mb-16"></i><span class="pr-33">Close</span></button>
				</div>
			</div>
		</div>
		<div class="ac l20"></div>

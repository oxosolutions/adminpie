		...
		<div class="ac l60 pt-25 aione-shadow pb-25 bg-grey bg-lighten-5">
			<div class="Wrapper aione-align-center">
				...
				<div class="button-wrap pt-10">
					<button class="bg-light-blue bg-darken-2 aione-shadow" onclick="window.location.href='<?php echo e(route('embed.survey',['token'=>request()->token])); ?>'"><i class="fa fa-rotate-left icon1 font-size-23 mb-16"></i>Start Again</button>
				</div>

...
<body>
	...
	<div style="width: 100%">
		...
		<div style="padding:20px 40px">
			<h5>Hi <?php echo e(@$model['name']); ?></h5>
			...
			<div style="width: 100%;text-align: center;padding: 18px 0px;">
				<a href="<?php echo e(route('edit.password')); ?>" style="background-color: #DB4F28;color: white;width: 200px;line-height: 38px;font-size: 18px;border: none">Reset Password</a>	
			</div>
			<p>
			...
			<p>
				...
				<a href="<?php echo e(route('edit.password')); ?>"><?php echo e(route('edit.password')); ?></a>
			</p>

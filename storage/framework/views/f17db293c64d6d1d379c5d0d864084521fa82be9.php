			...
			<div class="survey-settings-wrapper">
				<div class="ar">
					<div class="ac l100 m100 s100">
						<?php echo Form::model(@$model,['route' => ['save.survey.notifications',request()->route()->parameters()['id']], 'class'=> 'form-horizontal','method' => 'post']); ?>

							<?php echo FormGenerator::GenerateForm('survey_notification_form',[],$model); ?>

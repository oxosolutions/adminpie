<div class="row design-bg valign-wrapper">
		<div class="col s2">
			...
			// 		$ym = date('Y-m', strtotime($dt));
			 ?>
				...
				<a onclick="attendance_filter(<?php echo e($daily_previous_date); ?>, null, <?php echo e($daily_previous_month); ?> , <?php echo e($daily_previous_year); ?> )" style="cursor: pointer;" name="date" value="<?php echo e($daily_previous_date); ?>" class="nav left-align"><?php echo e($daily_previous_date); ?>Previous Day</a>
		</div>
		<div class="col s8">
		...
		<div class="col s2">
			<div class="right-align">
				<a onclick="attendance_filter(<?php echo e($daily_next_date); ?>, null, <?php echo e($daily_next_month); ?> , <?php echo e($daily_next_year); ?> )" style="cursor: pointer" name="date" value="<?php echo e($daily_next_date); ?>" class="nav right-align"><?php echo e($daily_next_date); ?>Next Day</a>

...
<nav id="aione_account_tabs" class="aione-account-tabs aione-nav aione-nav-horizontal">
    ...
    <ul class="aione-tabs">
        ...
        <li class="aione-tab nav-item-current ">
         ...
         <li class="aione-tab  ">
            <a href="<?php echo e(route('credentials.project',[$project_id])); ?>">
                 <span class="nav-item-text">Credentials</span></a>
        </li>
         <li class="aione-tab  ">
            <a href="<?php echo e(route('documentation.project',[$project_id])); ?>"> <span class="nav-item-text">Documentation</span></a>
        </li>
         <li class="aione-tab  ">
            <a href="<?php echo e(route('attachment.project',[$project_id])); ?>"> <span class="nav-item-text">Attachemnts</span></a>
        </li>
         <li class="aione-tab  ">
         ...
         <li class="aione-tab  ">
            <a href="<?php echo e(route('activities.project',[$project_id])); ?>"> <span class="nav-item-text">Activity</span></a>
        </li>
        <li class="aione-tab  ">
            <a href="#test4"> <span class="nav-item-text">Milestones</span></a>
        </li>
        <li class="aione-tab  ">
            <a href="<?php echo e(route('calender.project',[$project_id])); ?>"> <span class="nav-item-text">Calender</span></a>
        </li>
        <li class="aione-tab  ">

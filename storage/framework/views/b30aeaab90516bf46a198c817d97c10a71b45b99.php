                                    ...
                                    <li>
                                        <div class="row" style="margin-bottom: 0px;padding: 14px">
                                            ...
                                            <div class="col l6 right-align aione-field-wrapper">
                                               ...
                                               <?php echo Form::select('chart_type',['minimal','second opt'],null,["class"=>"no-margin-bottom aione-field select_2 browser-default  " , 'placeholder'=>'Chart Type','id'=>'chart_type']); ?>

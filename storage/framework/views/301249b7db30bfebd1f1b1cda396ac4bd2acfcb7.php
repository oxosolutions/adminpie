...
<?php if(@$model != null || @$model != ""): ?>
	<?php echo Form::model($model ,['route'=>'update.template' , 'class'=> 'form-horizontal','method' => 'post']); ?>

	<input type="hidden" name="id" value="<?php echo e(request()->route()->parameters()['id']); ?>">
<?php else: ?>
	<?php echo Form::open(['route'=>'save.template' , 'class'=> 'form-horizontal','method' => 'post']); ?>

<?php endif; ?>
		<?php echo FormGenerator::GenerateSection('emasec3',['type'=>'inset']); ?>

...
<div class="col l12"  >
    <ul class="aione-tabs">
        <li class="tab col aione-active <?php echo e(strpos($link, 'edit')?'aione-active':''); ?>"><a href="<?php echo e(Route('profile.edit')); ?>">General Info</a></li>
        <li class="tab col <?php echo e(strpos($link, 'personal-detail')?'aione-active':''); ?>""><a href="javascript:;">Personal Details</a></li>
        <li class="tab col <?php echo e(strpos($link, 'bank-detail')?'aione-active':''); ?>""><a href="javascript:;">Banking Details</a></li>
        <li class="tab col <?php echo e(strpos($link, 'changepassword')?'aione-active':''); ?>""><a href="<?php echo e(route('profile.changepassword')); ?>">Change Password</a></li>
    </ul>
</div>
<style type="text/css">

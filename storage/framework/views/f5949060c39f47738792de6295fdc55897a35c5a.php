...
<div class="row">
	...
	<?php echo Form::hidden('id',$data['id']); ?>
		...
		<div class="row" style="padding-bottom: 15px">
			...
			<div class="col l9">
				<?php echo e(Form::select('role_include[]',$data['roles'],@$data['role_include'],array('id'=>'role_include', 'multiple'=>'multiple', 'placeholder'=>"Select Role"))); ?>
			...
			<div class="col l9">
				<?php echo e(Form::select('roles_exclude[]',$data['roles'],@$data['data']['roles_exclude'],array('id'=>'roles_exclude','multiple'=>'multiple', 'placeholder'=>"Select Role"))); ?>
		...
		<div class="row" style="padding-bottom: 15px">
			...
			<div class="col l9">
				<?php echo e(Form::select('include_designation[]',$data['designationData'],@$data['data']['include_designation'],array('id'=>'designation_include', 'multiple'=>'multiple', 'placeholder'=>"Select Designation"))); ?>
			...
			<div class="col l9">
				<?php echo e(Form::select('exclude_designation[]',$data['designationData'],@$data['data']['exclude_designation'],array('id'=>'designation_exclude', 'multiple'=>'multiple', 'placeholder'=>"Select Designation"))); ?>
		...
		<div class="row" style="padding-bottom: 15px">
			...
			<div class="col l9">
				<?php echo e(Form::select('user_include[]',$data['userData'],@$data['user_include'],array('id'=>'user_include', 'multiple'=>'multiple', 'placeholder'=>"Select User"))); ?>
			...
			<div class="col l9">
				<?php echo e(Form::select('user_exclude[]',$data['userData'],@$data['user_exclude'],array('id'=>'user_exclude','multiple'=>'multiple', 'placeholder'=>"Select User"))); ?>

...
<?php echo $__env->make('common.page_content_primary_start', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	...
	<div id="hrm_attendance" class="hrm-attendance">
		...
		<input type="text" id="attendance_year" value="<?php echo e($init_date['year']); ?>" >
		<input type="text" id="attendance_month" value="<?php echo e($init_date['month']); ?>" >
		<input type="text" id="attendance_date" value="<?php echo e($init_date['date']); ?>" >
		<input type="text" id="attendance_week" value="<?php echo e($init_date['week']); ?>" >

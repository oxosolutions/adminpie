...
<div id="theme_<?php echo e($visualization_theme); ?>" class="wrapper p-10 theme-<?php echo e($visualization_theme); ?>">
	<div id="visualization_<?php echo e($visualization_id); ?>" class="main visualization visualization-<?php echo e($visualization_id); ?>">
		...
		<?php if(isset($meta['show_topbar']) && $meta['show_topbar'] == 1): ?>
			<!--==============================-->
			<div id="aione_topbar_<?php echo e($visualization_id); ?>" class="aione-border mb-10">
				...
				<div class="p-10">
					<?php $__currentLoopData = $titles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chart_id => $title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<div class="widget-toggle">
					      <input type="checkbox" class=" show-hide-charts" id="<?php echo e($chart_id); ?>_checkbox" data-hide="<?php echo e($chart_id); ?>" checked="checked" value="<?php echo e($chart_id); ?>"/>
		...
		<?php if(isset($meta['enable_header']) && $meta['enable_header'] == 1): ?>
			<!--==============================-->
			<div id="aione_header_<?php echo e($visualization_id); ?>" class="mb-10 p-10 aione-align-center font-size-22 font-weight-200 aione-border-bottom">
				<?php echo $visualization_name; ?> 
				<?php if(isset($meta['visualization_description']) && $meta['visualization_description'] != ''): ?>
				<div class="font-size-16 font-weight-400 grey line-height-24"><?php echo $meta['visualization_description']; ?></div>
				<?php endif; ?>
			</div> <!-- show_header -->
		<?php endif; ?>
						...
						<?php $__currentLoopData = $charts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chart_key => $chart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							...
							<?php else: ?>
								...
								<?php if($chart_enabled == 1): ?>
									<div id="chart_wrapper_<?php echo e($chart_id); ?>" chart-id="<?php echo e($chart['chart_id']); ?>" class="aione-chart aione-chart-<?php echo e($chart_type); ?> chart-theme-<?php echo e(@$chart_settings['custom_map_theme']); ?> chart-width-<?php echo e($chart_width); ?> <?php echo e(@$meta['collapsible_chart_widgets']=='1'?'aione-accordion':''); ?>">
										<div class="aione-item active">
											...
											>	<div class="aione-align-right">
													<i class="fa fa-cog chart_settings" data-chart_type="<?php echo e($chart['chart_type']); ?>" data-chartid="<?php echo e($chart['chart_id']); ?>" data-visualizationid="<?php echo e(request()->route('id')); ?>" data-target="chart_<?php echo e($chart['chart_id']); ?>_setings" style="font-size: 24px;color: #757575"></i>
												</div>

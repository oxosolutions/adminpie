	...
	<div class="ml-4">
		...
		<?php if(!empty($attendance_data[$j]['attendance_status'])): ?>
			<?php if($attendance_data[$j]['attendance_status']=='present'): ?>
				<div class="dark-green display-inline-block bg-grey  aione-align-center mt-4 line-height-80 aione-border border-grey border border-lighten-1" style="width: calc( 14.28% - 4px);"><?php echo e($j); ?>
			...
			<?php elseif($attendance_data[$j]['attendance_status']=='leave'): ?>
				<div class="display-inline-block bg-grey bg-lighten-3 aione-align-center mt-4 line-height-80 aione-border border-grey border border-lighten-1" style="width: calc( 14.28% - 4px);"><?php echo e($j); ?></div>			
			<?php else: ?>
				<div class="display-inline-block bg-grey bg-lighten-3 aione-align-center mt-4 line-height-80 aione-border border-grey border border-lighten-1" style="width: calc( 14.28% - 4px);"><?php echo e($j); ?></div>			<?php endif; ?>
		<?php else: ?>
		<div class="display-inline-block bg-grey bg-lighten-3 aione-align-center mt-4 line-height-80 aione-border border-grey border border-lighten-1" style="width: calc( 14.28% - 4px);"><?php echo e($j); ?></div>
		<?php endif; ?>

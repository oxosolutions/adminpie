...
<div class="aione-border">
	<div class="bg-grey bg-lighten-3 p-10 font-size-20 aione-border-bottom mb-30">
		...
		<div class="aione-float-right font-size-16	">
			<button class="aione-button monthly" year="<?php echo e($previous_yr); ?>" month="<?php echo e($previous_mo); ?>" style="margin-top: -10px">
				<i class="fa fa-chevron-left line-height-24 font-size-13"  ></i>
			</button>
			<span id="year_display"  class="aione-align-center display-inline-block" style="width: 200px"><?php echo e($current_mo); ?>, <?php echo e($current_yr); ?> </span>
			<button class="aione-button monthly" style="margin-top: -10px" year="<?php echo e($nxt_yr); ?>" month="<?php echo e($nxt_mo); ?>">
	...
	<div class="ml-4">
		...
		<?php if(!empty($attendance_data[$j]['attendance_status'])): ?>
			<?php if($attendance_data[$j]['attendance_status']=='present'): ?>
				<div class="attendance-status-present display-inline-block  aione-align-center mt-4 line-height-80 aione-border border-grey border border-lighten-1" style="width: calc( 14.28% - 4px);"><?php echo e($j); ?>

			</div>			
			<?php elseif($attendance_data[$j]['attendance_status']=='absent'): ?>
				<div class="display-inline-block attendance-status-absent  aione-align-center mt-4 line-height-80 aione-border border-grey border border-lighten-1" style="width: calc( 14.28% - 4px);"><?php echo e($j); ?></div>			
			...
			<?php elseif($attendance_data[$j]['attendance_status']=='leave'): ?>
				<div class="display-inline-block attendance-status-leave aione-align-center mt-4 line-height-80 aione-border border-grey border border-lighten-1" style="width: calc( 14.28% - 4px);"><?php echo e($j); ?></div>			
			<?php else: ?>
				<div class="display-inline-block light-green aione-align-center mt-4 line-height-80 aione-border border-grey border border-lighten-1" style="width: calc( 14.28% - 4px);"><?php echo e($j); ?></div>			<?php endif; ?>
		<?php else: ?>
		<div class="display-inline-block bg-grey bg-lighten-3 aione-align-center mt-4 line-height-80 aione-border border-grey border border-lighten-1" style="width: calc( 14.28% - 4px);"><?php echo e($j); ?></div>
		<?php endif; ?>

...
<div id="aione_header_right" class="aione-header-right">
    <div class="aione-row">
        <div class="aione-header-item aione-profile">
            <a href="#"><img class="user-avatar" src="<?php echo e(asset('assets/images/user.png')); ?>"></a>
                ...
                <div class="aione-row">
                    ...
                    <div class="aione-widget-footer">
                        ...
                        <div class="aione-widget-footer-right">
                            <a href="<?php echo e(route('admin.logout')); ?>" class="button aione-button aione-button-small aione-logout-button">Logout</a>

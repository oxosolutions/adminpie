    ...
    <div class="ar">
        <div class="ac l50">
            <div class="aione-border mv-10 p-10">
                ...
                <span class="aione-float-right font-size-18"><?php echo e(number_format(($payscale['total_salary'] + $salary['over_time']) , 2 ,"." ,",")); ?></span>
            </div>
        </div>
        <div class="ac l50">
            <div class="aione-border mv-10 p-10">
        ...
        <div class="ac l50">
            ...
            <ul class="aione-border">
                <li class="aione-border-bottom p-10">
                    ...
                    <span class="aione-float-right"><?php echo e(number_format(($payscale['total_salary'] + $salary['over_time']) , 2 ,"." ,",")); ?></span>
                </li>
                <li class="p-10">

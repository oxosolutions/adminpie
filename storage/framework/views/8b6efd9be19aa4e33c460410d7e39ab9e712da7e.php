...
::-webkit-scrollbar-thumb:window-inactive {
	...
	<body>
		...
		<div id="aione_wrapper" class="aione-wrapper aione-layout-wide aione-visualization <?php echo e($theme); ?>">
			<div class="aione-row">
				...
				<div id="aione_main" class="aione-main">
					<div class="aione-row">
						...
						<div id="aione_tooltip_data" class="aione-tooltip-data hide" style="display:none;"><?php echo e($data); ?></div><!-- #aione_tooltip_data -->
					</div><!-- .aione-row -->
				</div><!-- #aione_main -->

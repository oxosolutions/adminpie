...
if(request()->route()->uri == "survey/{token}"){
 ...
 ?>
<?php echo $__env->make('layouts.themes.theme-admin.includes._head', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	...
	<div id="aione_wrapper" class="aione-wrapper aione-layout-<?php echo e(@$design_settings['layout']); ?> aione-theme-arcane">
		<div class="aione-row">
			...
			<?php if(@$design_settings['show_header'] == 1): ?>
				<?php echo $__env->make('layouts.themes.theme-admin.includes._header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
			<?php endif; ?>
			<?php if(@$design_settings['show_slider'] == 1): ?>
				<?php echo $__env->make('layouts.themes.theme-admin.includes._slider', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
			<?php endif; ?>
			<?php if(@$design_settings['show_page_title'] == 1): ?>
				<?php echo $__env->make('layouts.themes.theme-admin.includes._pagetitle', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
			<?php endif; ?>
			...
			<?php if(@$design_settings['show_footer_widgets'] == 1): ?>
				<?php echo $__env->make('layouts.themes.theme-admin.includes._footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
			<?php endif; ?>
			<?php if(@$design_settings['show_copyright'] == 1): ?>
				<?php echo $__env->make('layouts.themes.theme-admin.includes._copyright', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
			<?php endif; ?>
		</div><!-- .aione-row -->
	</div><!-- #aione_wrapper -->

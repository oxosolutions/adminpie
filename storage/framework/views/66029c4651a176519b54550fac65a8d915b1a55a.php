  ...
  <ul class="aione-tabs">
      <li class="aione-tab profile-view-tab <?php echo e((Request::route()->action['as'] == 'profile.view')?'nav-item-current':''); ?>">
        <a href="<?php echo e(route('profile.view')); ?>">
          ...
          <span class="nav-item-text"><?php echo e(__('organization/profile.tab_view_profile')); ?></span></a>
      </li>
      <li class="aione-tab profile-edit-tab <?php echo e((Request::route()->action['as'] == 'profile.edit')?'nav-item-current':''); ?>">
        <a href="<?php echo e(route('profile.edit')); ?>">
        <span class="nav-item-icon " style="background:rgba(0, 0, 0, 0)"><i class="ion-compose ionic-icon"></i></span><span class="nav-item-text"><?php echo e(__('organization/profile.tab_edit_profile')); ?></span></a>
      </li>
      <li class="aione-tab profile-changepassword-tab <?php echo e((Request::route()->action['as'] == 'profile.changepassword')?'nav-item-current':''); ?>">
        <a href="<?php echo e(route('profile.changepassword')); ?>">
        <span class="nav-item-icon " style="background:rgba(0, 0, 0, 0)"><i class="ion-ios-unlocked ionic-icon"></i></span><span class="nav-item-text"><?php echo e(__('organization/profile.tab_change_password')); ?></span></a>
      </li>
      <li class="aione-tab profile-picture-tab <?php echo e((Request::route()->action['as'] == 'profile-picture.details')?'nav-item-current':''); ?>">
        <a href="<?php echo e(route('profile-picture.details')); ?>"><span class="nav-item-icon " style="background:rgba(0, 0, 0, 0)"><i class="ion-person ionic-icon"></i></span><span class="nav-item-text"><?php echo e(__('organization/profile.tab_profile_picture')); ?></span></a>
      </li>
      <div class="clear"></div>
  </ul>
</nav>

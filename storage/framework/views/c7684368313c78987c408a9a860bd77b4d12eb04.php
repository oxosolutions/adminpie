...
<?php echo Form::open(['route'=>'store.posts' , 'class'=> 'form-horizontal','method' => 'post']); ?>

  <?php echo $__env->make('common.modal-onclick',['data'=>['modal_id'=>'add_new_model','heading'=>'Add Post','button_title'=>'Save','form'=>'add_post_form']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo Form::close(); ?>

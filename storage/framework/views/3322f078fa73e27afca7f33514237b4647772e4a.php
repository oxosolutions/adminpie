		            ...
		            <ul class="aione-recent-items">
						<?php if(!$items->isEmpty()): ?>
		    				<?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item_key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<li class="item waves-effect aione-tooltip" data-tooltip="<?php echo e($item->name); ?> - <?php echo e($item->working_days); ?>">
								<span class="align-left" ><?php echo e($item->name); ?></span>
								<span class="align-right"><?php echo e($item->from); ?> - <?php echo e($item->to); ?></span>
								</li>
